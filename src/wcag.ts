...
export const WCAG: Record<string, WcagCriterion> = {
  ...
  "1.3.2": { id: "1.3.2", name: "Meaningful Sequence", level: "A" },
  "1.3.3": { id: "1.3.3", name: "Sensory Characteristics", level: "A" },
  "1.3.4": { id: "1.3.4", name: "Orientation", level: "AA" },
  ...
  "1.4.10": { id: "1.4.10", name: "Reflow", level: "AA" },
  "1.4.11": { id: "1.4.11", name: "Non-text Contrast", level: "AA" },
  "1.4.12": { id: "1.4.12", name: "Text Spacing", level: "AA" },
  "2.1.1": { id: "2.1.1", name: "Keyboard", level: "A" },
  "2.1.2": { id: "2.1.2", name: "No Keyboard Trap", level: "A" },
  "2.2.1": { id: "2.2.1", name: "Timing Adjustable", level: "A" },
  "2.2.2": { id: "2.2.2", name: "Pause, Stop, Hide", level: "A" },
  "2.3.3": { id: "2.3.3", name: "Animation from Interactions", level: "AAA" },
